    ...
    return (
      <div className="min-h-[calc(100vh-3.5rem)] flex items-center justify-center px-6">
        <div className="w-full max-w-sm border border-border bg-card p-8 text-center shadow-lg">
          ...
          <Button
            size="lg"
            className="w-full font-['Barlow_Condensed'] uppercase tracking-widest font-bold"
      ...
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button
            ...
            size="lg"
            className="w-full font-['Barlow_Condensed'] font-bold uppercase tracking-widest text-base mt-6 h-12"
          >
            {loading ? (
              'Updating...'
            ) : (
              <>
                Set Password <ArrowRight size={16} className="ml-2" />
              </>
            )}
          </Button>
        </form>
