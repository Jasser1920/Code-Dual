    ...
    <div className="min-h-[calc(100vh-3.5rem)] flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {loading ? (
              ...
              <>
                Send Reset Link <Send size={15} className="ml-2" />
              </>
            )}
          </Button>
        </form>
        ...
        <div className="mt-6 pt-6 border-t border-border flex justify-center">
          <Link
            to="/login"
            className="flex items-center gap-2 font-['Barlow_Condensed'] font-bold uppercase tracking-widest text-xs text-muted-foreground hover:text-foreground transition-colors"
          >
